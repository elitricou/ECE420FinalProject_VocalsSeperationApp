...
public class FragmentAudioRecorder extends Fragment {
    ...
    private void startRecording() {
        ...
        Date date = new Date();
        nameOfRecordedFile = recordedFilePath+"/"+simpleDateFormat.format(date) + getResources().getString(R.string._wav);
        wavRecorder.setOutputFile(nameOfRecordedFile);
    ...
    private void stopRecording() {
        if (((int) (SystemClock.elapsedRealtime() - chronometer.getBase())) > 400) {
            ...
            PyObject Repet = pyobj.callAttr("main", nameOfRecordedFile);
